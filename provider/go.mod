...
require (
	github.com/1Password/terraform-provider-onepassword/v3 v3.1.1-1
...
// Use fork of original TF provider here. Original provider is released with a v3.x tag but a v2 version suffix,
// so we can't use this one directly.
replace github.com/1Password/terraform-provider-onepassword/v3 => github.com/marnixbouhuis/terraform-provider-onepassword/v3 v3.3.1-1
