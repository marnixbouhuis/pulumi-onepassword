...
class GetVaultResult:
    ...
    def id(self) -> _builtins.str:
        """
        The Terraform resource identifier for this item in the format `vaults/<vault_id>`
        """
...
def get_vault(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: The name of the vault to retrieve. This field will be populated with the name of the vault if the vault it looked up by its UUID.
    :param _builtins.str uuid: The UUID of the vault to retrieve. This field will be populated with the UUID of the vault if the vault it looked up by its name.
    """
    __args__ = dict()
    __args__['name'] = name
    __args__['uuid'] = uuid
...
def get_vault_output(name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('onepassword:index/getVault:getVault', __args__, opts=opts, typ=GetVaultResult)
